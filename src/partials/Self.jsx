                    ...
                    <div className="pt-20 md:pt-20 pb-20">
                        ...
                        <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6 md:mt-6"
                            ...
                            <div className="mb-8 text-center">
                                <h3 className={'text-blue-100 text-2xl h3 md:text-3xl'}>Performance Review - Self</h3>
                            </div>
                        </div>
                        {/* Section form */}
                                        ...
                                        <div className="flex flex-col gap-y-2 w-full">
                                            ...
                                            <div className="flex items-center border-b border-grey-700 py-2">
                                                {item.type === 'text' ? <input
                                                    ...
                                                    type={item.type} /> :
                                                    <div className="mt-2 flex items-center flex-row items-center justify-center w-full pb-12 md:py-14">
