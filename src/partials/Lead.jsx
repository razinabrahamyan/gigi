                ...
                <div className="pt-20 md:pt-20 pb-20">
                    ...
                    <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6 md:mt-6"
                        ...
                        <div className="mb-8 text-center">
                            <h3 className={'header-color h3'}>Performance Review - Lead</h3>
                        </div>
                    </div>
                    {/* Section form */}
                    ...
                    <form className="w-full">
                        ...
                        <div className="mt-4 bg-white rounded-t-lg rounded-b-lg border-r border-b border-l border-t border-gray-200 rounded p-4 flex">
                            <div className="flex flex-col gap-y-2 w-full">
                                <label htmlFor="adversities" className={'text-black-700 font-bold'}> What adversities have they battled this term?</label>
                                <div className="flex items-center border-b border-grey-700 py-2">
                                    <input
                                        className="appearance-none bg-transparent border-none w-full text-gray-700 mr-3
                                     py-1 px-2 leading-tight"
                        ...
                        <div className="mt-4 bg-white rounded-t-lg rounded-b-lg border-r border-b border-l border-t border-gray-200 rounded p-4 flex">
                            <div className="flex flex-col gap-y-2 w-full">
                                <label htmlFor="next-term" className={'text-black-700 font-bold'}>For the next term, I suggest they work on: (2 or 3 actionable things)</label>
                                <div className="flex items-center border-b border-grey-700 py-2">
                                    <input
                                        className="appearance-none bg-transparent border-none w-full text-gray-700 mr-3
                                     py-1 px-2 leading-tight"
